define([
    ...
    function (_, Backbone, $, i18n) {
        ...
        var wrapper = function (data) {
            ...
            state.cmd.setHandler("cmd:app:load:locales", webTranslator.init);
            ...
            _.extend(webTranslator, {
                ...
                flatten: function (store, options) {
                    ...
                    state.set("data:flattenedLocales", flat);
                },
                ...
                update: function (lng, ns, key, value, cb) {
                    ...
                    var url = applyReplacement(this.options.resChangePath, {
                        lng: lng,
                        ns: ns
                    });
                ...
                remove: function (lng, ns, key, value, cb) {
                    ...
                    var url = applyReplacement(this.options.resRemovePath, {
                        lng: lng,
                        ns: ns
                    });
